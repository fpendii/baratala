...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url('data-jobdesk/store') }}" method="POST">
                @csrf
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            ...
                            <select class="form-select @error('divisi') is-invalid @enderror" name="divisi" required>
                                <option value="" disabled {{ old('divisi') == null ? 'selected' : '' }}>
                                    Pilih Divisi
                                </option>
                                <option value="kepala_teknik_tambang"
                                    {{ old('divisi') == 'kepala_teknik_tambang' ? 'selected' : '' }}>
                                ...
                                <option value="umum" {{ old('divisi') == 'umum' ? 'selected' : '' }}>
                                    Umum
                                </option>
                            </select>
                    ...
                    <div class="jobdesk-item row mb-4">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control @error('judul_jobdesk.0') is-invalid @enderror"
                                    name="judul_jobdesk[]" {{-- NAMA INI ARRAY --}} placeholder="Masukkan Judul Jobdesk"
                                    value="{{ old('judul_jobdesk.0') }}" required />
                                {{-- Tombol Hapus: Hanya muncul di item > 1 --}}
                                <button type="button" class="btn btn-outline-danger remove-jobdesk d-none"
                                    title="Hapus Jobdesk"><i class="ri ri-close-line"></i></button>
                            </div>
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-10">
                        <a href="{{ url('data-jobdesk') }}" class="btn btn-secondary">Batal</a>
